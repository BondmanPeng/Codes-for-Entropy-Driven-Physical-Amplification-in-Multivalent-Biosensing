...
int main(int argc, char* argv[]){
    ...
    double mu_m=stod(argv[8]);
    // double mu_lm=mu_m; double mu_rm=mu_m;
    double xim=stod(argv[9]);
    // double xi=exp(-2);
    ...
    for(int q=0;q<25;q++){
        ...
        System host_guest;
        host_guest.initialize_system(mu_g,rho_r,mu_linker,mu_m,nl,kr,kl,xi_r,xi_l,xim,fcnf,area);
